...
# Initialize Probability Transition Tensor
prob_transition_tensor = list()
...
# Generate Figure
legend_dict = {'g_fc': '$GC_{'+str(filters_1)+'}-FC_{'+str(num_hidden_1)+'}$',
               'g_wsim_fc': '$GCWSIM_{'+str(filters_1)+'}-FC_{'+str(num_hidden_1)+'}$',
               'dc_fc': '$DC_{'+str(filters_1)+'}-FC_{'+str(num_hidden_1)+'}$',
               'dc_mfd_fc': '$DCMFD_{'+str(filters_1)+'}-FC_{'+str(num_hidden_1)+'}$',
                }
...
plt.plot(x, results['g_fc'], label = legend_dict['g_fc'], marker = 's', markersize = 8, linewidth=2)
plt.plot(x, results['g_wsim_fc'], label = legend_dict['g_wsim_fc'], marker = '8', markersize = 8, linewidth = 2)
plt.plot(x, results['dc_fc'], label = legend_dict['dc_fc'], marker = '^', markersize = 8, linewidth = 2)
plt.plot(x, results['dc_mfd_fc'], label = legend_dict['dc_mfd_fc'], marker = 'D', markersize = 8, linewidth = 2)
...
plt.savefig('results/plot_graph_conv_fc_K='+str(K)+'.png', bbox_inches='tight')
